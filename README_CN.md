...
### 🎓 **每个模板配套官方模板题 - 学完即可验证**
- ✅ **配套模板题**：每个算法都标注了对应的**洛谷/Codeforces 模板题号**
  - 例如：Dijkstra → 洛谷 P3371、KMP → 洛谷 P3375
- 🔍 **快速搜索**：直接复制题号就能在平台上找到对应题目
- 💯 **即学即练**：看完代码 → 理解注释 → 提交模板题 → AC验证
- 📈 **循序渐进**：从模板题 → 变体题 → 综合应用题

> **这样设计的好处**：不会出现"学了但不知道怎么用"的情况，每个算法都有明确的练习入口！
...
| 没有配套练习题 | **每个模板配套洛谷/CF模板题号** |
| 不知道常见变体 | **详细说明3-5种常见变体及修改方法** |
 ...
 * 
 * 适用场景：何时使用这个算法
 * 模板题：洛谷 P3371 - 【模板】单源最短路径（弱化版）  ← 配套题号，可直接搜索
...
**这些额外信息的价值**：
- 🔑 **关键点**：帮你抓住算法本质，面试/考试时能快速回忆
- 🔄 **常见变体**：90%的题目都是模板的变形，这里直接告诉你怎么改
- ✅ **提交前检查**：避免低级错误，提高一次AC率
